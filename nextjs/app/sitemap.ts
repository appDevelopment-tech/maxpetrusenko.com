...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    {
      url: `${baseUrl}/who-is-max-petrusenko`,
      lastModified: await getRouteLastModified(appDir, "/who-is-max-petrusenko", fallbackLastModified),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${baseUrl}/max-petrusenko-ai-automation`,
      lastModified: await getRouteLastModified(appDir, "/max-petrusenko-ai-automation", fallbackLastModified),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${baseUrl}/max-petrusenko-aeo-geo`,
      lastModified: await getRouteLastModified(appDir, "/max-petrusenko-aeo-geo", fallbackLastModified),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${baseUrl}/max-petrusenko-somatic`,
      lastModified: await getRouteLastModified(appDir, "/max-petrusenko-somatic", fallbackLastModified),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${baseUrl}/max-petrusenko-mindfold`,
      lastModified: await getRouteLastModified(appDir, "/max-petrusenko-mindfold", fallbackLastModified),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${baseUrl}/max-petrusenko-reviews`,
      lastModified: await getRouteLastModified(appDir, "/max-petrusenko-reviews", fallbackLastModified),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
